...
import com.spring.packagedeliveryservice.exception.ComponentTypeNotFoundException;
...
public class CostCalculatorController {
	...
	public ResponseEntity<Object> getPackagingAndDeliveryCharge(@PathVariable String componentType, @PathVariable int count) throws ComponentTypeNotFoundException  {
